...
dataset['read_function'] = lpt.readdata.get_cfsr_6h_rain
...
lpo_options['filter_stdev'] = 10             # Gaussian filter width, in terms of grid points.
...
lpt_options['min_overlap_points'] = 400      # LP object connectivity is based on points
