...
plotting['time_lon_range'] = [40, 300]       # Longitude Range for time-longitude plots.
...
lpt_options['min_overlap_points'] = 19000      # LP object connectivity is based on points
lpt_options['min_overlap_frac'] = 0.5         # -- OR fraction of either LP object.
lpt_options['min_lp_objects_points'] = 4900    # Disregard LP objects smaller than this.
